...
#from .FZ3 import process_image
from .FZ4 import ImageEnhancementModule
class Mlp(nn.Module):
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.process_image = ImageEnhancementModule()
    ...
    def forward(self, x):
        ...
        #x_downsample[0] = process_image(x_downsample[0])
        #x_downsample[1] = process_image(x_downsample[1])
        #x_downsample[2] = process_image(x_downsample[2])
        #x_downsample[3] = process_image(x_downsample[3])
